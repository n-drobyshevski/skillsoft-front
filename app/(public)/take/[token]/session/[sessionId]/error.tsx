...
/**
 * Error Boundary for Test Session Section.
 *
 * Catches unhandled errors in the active test session pages and provides
...
export default function TestSessionError({
  ...
  useEffect(() => {
    ...
    console.error('Test session page error:', {
      name: error.name,
  ...
  const errorInfo = useMemo(() => {
    ...
    if (lowerMessage.includes('session') || lowerMessage.includes('сессия') || lowerMessage.includes('expired') || lowerMessage.includes('completed')) {
      return {
