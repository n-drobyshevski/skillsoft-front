...
/**
 * Error Boundary for Teams Section.
 *
 * Catches unhandled errors in team management pages and provides
...
export default function TeamsError({
  ...
  useEffect(() => {
    ...
    console.error('Teams page error:', {
      name: error.name,
  ...
  const errorInfo = useMemo(() => {
    ...
    if (lowerMessage.includes('team') || lowerMessage.includes('команд')) {
      return {
