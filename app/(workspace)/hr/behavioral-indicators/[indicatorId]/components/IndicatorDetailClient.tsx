...
import { EntityDetailHeader } from "@/app/components/EntityDetailHeader";
import { deleteIndicator } from "@/app/actions";
import { approvalStatusToColor, levelToColor, formatProficiencyLevel } from "@/app/components/entity-utils";
