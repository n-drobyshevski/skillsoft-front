...
/**
 * Error Boundary for Settings Section.
 *
 * Catches unhandled errors in settings pages and provides
...
export default function SettingsError({
  ...
  const errorInfo = useMemo(() => {
    ...
    if (lowerMessage.includes('setting') || lowerMessage.includes('настройк')) {
      return {
        category: ErrorCategory.SERVER,
        title: t('serverError'),
