...
/**
 * Error Boundary for Test Result Detail Section.
 *
 * Catches unhandled errors in individual test result pages and provides
 ...
 */
export default function TestResultError({
  error,
  reset,
}: {
  error: Error & {
  ...
  useEffect(() => {
    ...
    console.error('Test result page error:', {
      name: error.name,
