...
// ============================================
// TYPE DEFINITIONS
// Re-exported from shared types (src/types/blueprint.ts) so that both
// server actions and Zustand stores can import from one canonical source.
// ============================================
