    ...
    <div className="relative">
      ...
      <section className="pt-32 pb-20 px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-20 right-20 w-72 h-72 bg-gradient-to-br from-primary/5 to-transparent rounded-full blur-3xl animate-pulse-glow"></div>
          <div className="absolute bottom-20 left-20 w-96 h-96 bg-gradient-to-tr from-primary/3 to-transparent rounded-full blur-3xl animate-float"></div>
          ...
          <div className="absolute top-2/3 right-1/4 w-8 h-1 bg-gradient-to-r from-primary/20 to-transparent animate-fade-in-up"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent rounded-3xl animate-gradient"></div>
              <Card className="card-modern relative p-8 hover-lift shadow-modern-lg transition-all duration-500">
                <div className="space-y-6">
                  ...
                  <div className="h-16 bg-gradient-to-r from-primary/10 to-primary/5 rounded-lg flex items-center justify-center relative overflow-hidden animate-scale-in" style={{ animationDelay: '1s' }}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="group p-8 bg-background/50 backdrop-blur-sm border-border/50 rounded-xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <div className="space-y-4">
                <div className="w-12 h-12 bg-gradient-to-br from-primary to-primary/60 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
