...
export const mockBehavioralIndicators: BehavioralIndicator[] = [
  ...
  },
  {
    ...
    weight: 0.5,
    orderIndex: 1,
    observabilityLevel: 'EXPERT',
    measurementType: 'IMPACT',
...
export const handlers = [
  ...
  http.post(`${API_BASE}/competencies`, async ({ request }) => {
    ...
    const newCompetency: Competency = {
      ...
      category: body.category || 'INTERPERSONAL',
  ...
  http.post(`${API_BASE}/behavioral-indicators`, async ({ request }) => {
    ...
    const newIndicator: BehavioralIndicator = {
      ...
      observabilityLevel: body.observabilityLevel || 'NOVICE',
      measurementType: body.measurementType || 'FREQUENCY',
      examples: body.examples || '',
      counterExamples: body.counterExamples || '',
      isActive: body.isActive ?? true,
      approvalStatus: body.approvalStatus || 'DRAFT',
      contextScope: body.contextScope || 'UNIVERSAL',
    };
  ...
  http.post(`${API_BASE}/questions`, async ({ request }) => {
    ...
    const newQuestion: AssessmentQuestion = {
      ...
      questionType: body.questionType || 'LIKERT_SCALE',
